        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div className="bg-gray-50 dark:bg-slate-700 p-4 rounded-lg">
              ...
              <p className="font-semibold">{server.language}</p>
            </div>
            <div className="bg-gray-50 dark:bg-slate-700 p-4 rounded-lg">
            ...
            <div className="bg-gray-50 dark:bg-slate-700 p-4 rounded-lg">
              ...
              <p className="font-semibold">{server.lastUpdated}</p>
            </div>
            <div className="bg-gray-50 dark:bg-slate-700 p-4 rounded-lg">
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-6 mt-6">
            <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
              <div className="flex flex-col gap-1">
                <div>
                  <span className="text-gray-500 dark:text-gray-400">Author:</span> {server.author}
                </div>
                {server.source && (
                  <div>
              ...
              <div className="flex gap-3">
                <Link href={`/playground?server=${server.id}`}>
